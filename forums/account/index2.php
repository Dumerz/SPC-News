...
$date = date('y-m-d');
mysql_query("INSERT INTO topics1 VALUES ('','".$topic_title."','".$topic_content."','".$date."','".$user_id."')");
...
$date = date('y-m-d');
mysql_query("INSERT INTO comments2 VALUES ('','".$topic_id."','".$user_id."','".$comment."','".$date."')");
...
{?>
<a href="index2.php" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;"><strong>Back to topic Index </strong></a>
<?php }?>

<?php if(isset($user))
{?>
<strong><a style="color:#3B5998;font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;"><?php if(isset($_GET['topic_id'])){?>-<?php }?><?php if(!isset($_GET['topic_id'])){?><a href="index2.php?new_topic" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;"><strong> - Create new Topic</strong></a><?php }?><a href="index2.php?log_out" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;"><strong> - Log out</strong></a><br />
<?php }?>
...
{
$topic_id = $_GET['topic_id'];
$query_comments = mysql_query("SELECT * FROM comments2 WHERE topic_id='".$topic_id."' ");
$count_comments = mysql_num_rows($query_comments);

$query_topic_content = mysql_query("SELECT * FROM topics1 WHERE topic_id='".$topic_id."' ");
...
$query_topics = mysql_query("SELECT * FROM topics1");
...
<a href="index2.php?topic_id=<?php echo $fetch_topics['topic_id'];?>" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px;" ><strong style="color:#3B5998;"><?php echo $fetch_user_topic['full_name'];?></strong> : <?php echo $fetch_topics['topic_title'];?></a><br>
