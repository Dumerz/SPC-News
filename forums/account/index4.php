						  ...
						  <div class="cbp-hrsub" style=" left: -825">
							<div class="cbp-hrsub-inner">
									<div style="width: 20%">
										...
										<a href="../../news/current.html"><h4>Whats News</h4></a>
                                    </div>
                                    <div style="width: 20%">
                                    	<img src="../../img/menu/2.jpg">                                    
										<a href="../../news/advisory.html"><h4>Photo Pic?</h4></a>
									</div>
									<div style="width: 20%">
                                    	<img src="../../img/menu/3.jpg">                                         
										<a href="../../news/business.html"><h4>Quest Forums</h4></a>
									</div>                                    
									<div style="width: 20%">
                                    	<img src="../../img/menu/4.jpg">                                         
										<a href="../../news/agri.html"><h4>SPC ChatRum</h4></a>
									</div>
									<div style="width: 20%">
                                    	<img src="user_images/<?php echo $user_image;?>">
                                        <ul>                                         
										<li><?php echo $user_fullname;?></li>
										<li><a href="index4.php?log_out">Log Out</a></li>
                                        </ul>
									</div>
						    </div><!-- /cbp-hrsub-inner -->
						  </div><!-- /cbp-hrsub -->
...
$date = date('y-m-d');
mysql_query("INSERT INTO topics3 VALUES ('','".$topic_title."','".$topic_content."','".$date."','".$user_id."')");
echo '<meta HTTP-EQUIV="REFRESH" content="0; url=index4.php">';
}
?>
<!--adding topic-->
...
$date = date('y-m-d');
mysql_query("INSERT INTO comments4 VALUES ('','".$topic_id."','".$user_id."','".$comment."','".$date."')");
...
{?>
<a href="index4.php" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;"><strong>Back to topic Index </strong></a>
<?php }?>

<?php if(isset($user))
{?>
<strong><a style="color:#3B5998;font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;"><?php if(isset($_GET['topic_id'])){?>-<?php }?><?php if(!isset($_GET['topic_id'])){?><a href="index4.php?new_topic" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;"><strong> - Create new Topic</strong></a><?php }?><a href="index4.php?log_out" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;"><strong> - Log out</strong></a><br />
<?php }?>
...
{
$topic_id = $_GET['topic_id'];
$query_comments = mysql_query("SELECT * FROM comments4 WHERE topic_id='".$topic_id."' ");
$count_comments = mysql_num_rows($query_comments);

$query_topic_content = mysql_query("SELECT * FROM topics3 WHERE topic_id='".$topic_id."' ");
...
<table width="500px;" style="font-family:Tahoma, Geneva, sans-serif; font-size:11px;">
  ...
  <tr>
    <td style="color:#666;"> <?php echo $fetch_comments['comment'];?></td>
  </tr>
</table>
</td></tr>
<?php
...
?>
<strong><a href="index4.php" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;">Back to Topic Index</a></strong>
<?php
}
else
{
...
$query_topics = mysql_query("SELECT * FROM topics3");
...
?>
<tr><td width="100%" style="padding-bottom:5px; padding-top:5px;">

<a href="index4.php?topic_id=<?php echo $fetch_topics['topic_id'];?>" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px;" ><strong style="color:#3B5998;"><?php echo $fetch_user_topic['full_name'];?></strong> : <?php echo $fetch_topics['topic_title'];?></a><br>
