						  ...
						  <div class="cbp-hrsub" style=" left: -825">
							<div class="cbp-hrsub-inner">
									...
									<div style="width: 20%">
										...
										<li><a href="index3.php?log_out">Log Out</a></li>
                                        </ul>
									</div>
						    </div><!-- /cbp-hrsub-inner -->
						  </div><!-- /cbp-hrsub -->
...
$date = date('y-m-d');
mysql_query("INSERT INTO topics2 VALUES ('','".$topic_title."','".$topic_content."','".$date."','".$user_id."')");
...
$date = date('y-m-d');
mysql_query("INSERT INTO comments3 VALUES ('','".$topic_id."','".$user_id."','".$comment."','".$date."')");
...
{?>
<a href="index3.php" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;"><strong>Back to topic Index </strong></a>
<?php }?>

<?php if(isset($user))
{?>
<strong><a style="color:#3B5998;font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;"><?php if(isset($_GET['topic_id'])){?>-<?php }?><?php if(!isset($_GET['topic_id'])){?><a href="index3.php?new_topic" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;"><strong> - Create new Topic</strong></a><?php }?><a href="index3.php?log_out" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;"><strong> - Log out</strong></a><br />
<?php }?>
...
{
$topic_id = $_GET['topic_id'];
$query_comments = mysql_query("SELECT * FROM comments3 WHERE topic_id='".$topic_id."' ");
$count_comments = mysql_num_rows($query_comments);

$query_topic_content = mysql_query("SELECT * FROM topics2 WHERE topic_id='".$topic_id."' ");
...
?>
<strong><a href="index3.php" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;">Back to Topic Index</a></strong>
<?php
}
else
{
...
$query_topics = mysql_query("SELECT * FROM topics2");
...
<a href="index3.php?topic_id=<?php echo $fetch_topics['topic_id'];?>" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px;" ><strong style="color:#3B5998;"><?php echo $fetch_user_topic['full_name'];?></strong> : <?php echo $fetch_topics['topic_title'];?></a><br>
