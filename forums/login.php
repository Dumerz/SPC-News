...
<?php if(isset($user))
{?>
<strong><a style="color:#3B5998;font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;"><?php if(isset($_GET['topic_id'])){?>-<?php }?> Logged in as : <span style="color:#333;"><?php echo $user_fullname;?></span></a></strong><a href="index.php?log_out" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-decoration:none;"><strong> - Log out</strong></a><br />
<br/><a href="index.php">Join Our Talk Today</a><br/>
<img width="100" height="100" style="margin: 10px; " src="user_images/<?php echo $user_image ?>"/>
<?php }?>
